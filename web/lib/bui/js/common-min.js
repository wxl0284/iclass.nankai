define("bui/common", ["jquery"], function (e, t, n) {
    var i = e("bui/common/util");
    i.mix(i, {
        UA: e("bui/common/ua"),
        JSON: e("bui/common/json"),
        Date: e("bui/common/date"),
        Array: e("bui/common/array"),
        KeyCode: e("bui/common/keycode"),
        Observable: e("bui/common/observable"),
        Base: e("bui/common/base"),
        Component: e("bui/common/component/component")
    }), n.exports = i
}), define("bui/common/util", ["jquery"], function (e, t, n) {
    function i(e, t) {
        for (var n in t) t.hasOwnProperty(n) && (e[n] = e[n] || {}, r(e[n], t[n]))
    }

    function r(e, t) {
        for (var n in t) t.hasOwnProperty(n) && ("value" == n ? BUI.isObject(t[n]) ? (e[n] = e[n] || {}, BUI.mix(e[n], t[n])) : BUI.isArray(t[n]) ? (e[n] = e[n] || [], e[n] = e[n].concat(t[n])) : e[n] = t[n] : e[n] = t[n])
    }
    ...
    var a = window, s = document, u = Object.prototype, l = u.toString, c = "body", d = "documentElement", f = "scroll",
        h = f + "Width", g = f + "Height", m = "ATTRS", v = "PARSER", p = "guid";
    window.BUI = window.BUI || {}, o.extend(BUI, {
        version: "1.1.0", isFunction: function (e) {
            ...
            return e.prototype = BUI.mix(o, e.prototype), e.superclass = r(t.prototype, t), BUI.mix(o, n), BUI.mix(e, i), e
        }, guid: function () {
            var e = {};
            return function (t) {
                return t = t || BUI.prefix + p, e[t] ? e[t] += 1 : e[t] = 1, t + e[t]
            }
        }(), isString: function (e) {
            ...
            BUI.debug && a.console && a.console.log && a.console.log(e)
        }, merge: function () {
            var e = o.makeArray(arguments), t = e[0];
        ...
        }, mixAttrs: i, mixAttr: r, mixin: function (e, t, n) {
            n = n || [m, v];
            var r = t;
            if (r) {
                e.mixins = r;
                var o = {}, a = r.concat(e);
                BUI.each(a, function (e) {
                    e && BUI.each(n, function (t) {
                        e[t] && (o[t] = o[t] || {}, "ATTRS" == t ? i(o[t], e[t]) : BUI.mix(o[t], e[t]))
                    })
            ...
            return BUI.isString(e) && (BUI.isObject(t) || BUI.isArray(t)) ? e.replace(n || /\\?\{([^{}]+)\}/g, function (e, n) {
            ...
            var t = e.left, n = e.top, i = BUI.viewportWidth(), r = BUI.viewportHeight(), o = BUI.scrollTop(),
                a = BUI.scrollLeft();
            ...
            if (!e && !t) return e;
            for (var i = t.split("."), r = e, o = i.length, a = 0; o > a && (r && BUI.isObject(r)); a++) {
                var s = i[a];
                if (a === o - 1) {
                    r[s] = n;
                    break
            ...
            if (!e && !t) return null;
            for (var n = t.split("."), i = e, r = n.length, o = null, a = 0; r > a && (i && BUI.isObject(i)); a++) {
                var s = n[a];
                if (a === r - 1) {
                    o = i[s];
                    break
    ...
    var y = {
        serializeToObject: function (e) {
            ...
            var i = e.elements[t];
            i && i.type ? y._setFieldValue(i, n) : (BUI.isArray(i) || i && i.length) && BUI.each(i, function (e) {
                y._setFieldValue(e, n)
            })
        }, _setFieldValue: function (e, t) {
            "checkbox" === e.type ? e.value == "" + t || BUI.isArray(t) && -1 !== BUI.Array.indexOf(e.value, t) ? o(e).attr("checked", !0) : o(e).attr("checked", !1) : "radio" === e.type ? e.value == "" + t ? o(e).attr("checked", !0) : o(e).attr("checked", !1) : o(e).val(t)
        }, getField: function (e, t) {
            return BUI.FormHelper.serializeToObject(e)[t]
        }
    };
    BUI.FormHelper = y, n.exports = BUI
}), define("bui/common/ua", ["jquery"], function (e, t, n) {
    function i(e) {
        var t = 0;
    ...
    function r(e) {
        ...
        var t = /(chrome)[ \/]([\w.]+)/.exec(e) || /(webkit)[ \/]([\w.]+)/.exec(e) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(e) || /(msie) ([\w.]+)/.exec(e) || e.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(e) || [],
            n = {browser: t[1] || "", version: t[2] || "0"}, i = {};
        return n.browser && (i[n.browser] = !0, i.version = n.version), i.chrome ? i.webkit = !0 : i.webkit && (i.safari = !0), i
    }

    var o = e("jquery"), a = o.UA || function () {
        var e = o.browser || r(navigator.userAgent), t = i(e.version),
            n = {ie: e.msie && t, webkit: e.webkit && t, opera: e.opera && t, mozilla: e.mozilla && t};
        return n
    }();
    n.exports = a
}), define("bui/common/json", ["jquery"], function (e, t, n) {
    function i(e) {
        return 10 > e ? "0" + e : e
    }
    ...
    function o(e, t) {
        ...
        switch (c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof h && (c = h.call(t, e, c)), typeof c) {
            ...
            case"object":
                ...
                if (h && "object" == typeof h) for (s = h.length, n = 0; s > n; n += 1) i = h[n], "string" == typeof i && (a = o(i, c), a && u.push(r(i) + (d ? ": " : ":") + a)); else for (i in c) Object.hasOwnProperty.call(c, i) && (a = o(i, c), a && u.push(r(i) + (d ? ": " : ":") + a));
                return a = 0 === u.length ? "{}" : d ? "{\n" + d + u.join(",\n" + d) + "\n" + l + "}" : "{" + u.join(",") + "}", d = l, a
        }
    }
    ...
    var s = e("jquery"), u = e("bui/common/ua"), l = window, c = l.JSON;
    (!c || u.ie < 9) && (c = l.JSON = {}), "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function (e) {
    ...
    "function" != typeof c.stringify && (c.stringify = function (e, t, n) {
        var i;
        if (d = "", f = "", "number" == typeof n) for (i = 0; n > i; i += 1) f += " "; else "string" == typeof n && (f = n);
        if (h = t, t && "function" != typeof t && ("object" != typeof t || "number" != typeof t.length)) throw new Error("JSON.stringify");
        return o("", {"": e})
    });
    var c = {parse: s.parseJSON, looseParse: a, stringify: c.stringify};
    n.exports = c
}), define("bui/common/date", [], function (e, t, n) {
    function i(e, t) {
        ...
        e += "";
        var a, s, u = 0, l = 0, c = "", d = "", f = new Date, h = f.getYear(), g = f.getMonth() + 1, m = 1, v = 0,
            p = 0, y = 0;
        ...
        if (2 == g) if (h % 4 == 0 && h % 100 != 0 || h % 400 == 0) {
            if (m > 29) return null
    ...
    var o = /^(?:(?!0000)[0-9]{4}([-/.]+)(?:(?:0?[1-9]|1[0-2])\1(?:0?[1-9]|1[0-9]|2[0-8])|(?:0?[13-9]|1[0-2])\1(?:29|30)|(?:0?[13578]|1[02])\1(?:31))|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)([-/.]?)0?2\2(?:29))(\s+([01]|([01][0-9]|2[0-3])):([0-9]|[0-5][0-9]):([0-9]|[0-5][0-9]))?$/,
        a = function () {
            ...
            return function (a, s, u) {
                ...
                var l = u ? "getUTC" : "get", c = a[l + "Date"](), d = a[l + "Day"](), f = a[l + "Month"](),
                    h = a[l + "FullYear"](), g = a[l + "Hours"](), m = a[l + "Minutes"](), v = a[l + "Seconds"](),
                    p = a[l + "Milliseconds"](), y = u ? 0 : a.getTimezoneOffset(), b = {
                        d: c,
                        dd: i(c, void 0),
                        ddd: o.dayNames[d],
                        dddd: o.dayNames[d + 7],
            ...
            add: function (e, t, n) {
                ...
                return BUI.isString(e) && (e = e.replace("/", "-")), i(e, t)
            }, today: function () {
                var e = new Date;
    ...
    n.exports = s
}), define("bui/common/array", ["jquery"], function (e, t, n) {
    var i = e("bui/common/util"), r = {
        peek: function (e) {
            return e[e.length - 1]
        }, indexOf: function (e, t, n) {
            for (var i = null == n ? 0 : 0 > n ? Math.max(0, t.length + n) : n, r = i; r < t.length; r++) if (r in t && t[r] === e) return r;
            return -1
        }, contains: function (e, t) {
            return r.indexOf(e, t) >= 0
        }, each: i.each, equals: function (e, t) {
            if (e == t) return !0;
            if (!e || !t) return !1;
            if (e.length != t.length) return !1;
            for (var n = !0, i = 0; i < e.length; i++) if (e[i] !== t[i]) {
                n = !1;
                break
            }
            return n
    ...
    n.exports = r
}), define("bui/common/keycode", [], function (e, t, n) {
    var i = {
        BACKSPACE: 8,
        TAB: 9,
        NUM_CENTER: 12,
    ...
    n.exports = i
}), define("bui/common/observable", ["jquery"], function (e, t, n) {
    function i() {
        return new s
    }

    var r = e("jquery"), o = e("bui/common/util"), a = e("bui/common/array"), s = function () {
        this._init()
    };
    o.augment(s, {
    ...
    o.augment(u, {
        _events: [], _eventMap: {}, _bubblesEvents: [], _bubbleTarget: null, _getCallbacks: function (e) {
            ...
            var t = this, n = null;
            if (e && (n = e.listeners || {}, e.handler && (n.click = e.handler), n)) for (var i in n) n.hasOwnProperty(i) && t.on(i, n[i])
            ...
            var n = this, r = n._events, s = n._eventMap;
            ...
            var n, i = this, o = i._getCallbacks(e), a = r.makeArray(arguments);
            ...
            var n = this, i = n._getCallbacks(e);
            return i && (t ? i.remove(t) : i.empty()), n
        }, publish: function (e, t) {
            var n = this, i = n._bubblesEvents;
            if (t.bubbles) -1 === o.Array.indexOf(e, i) && i.push(e); else {
                var r = o.Array.indexOf(e, i);
                -1 !== r && i.splice(r, 1)
            }
        }
    }), n.exports = u
}), define("bui/common/base", ["jquery"], function (e, t, n) {
    function i(e, t, n) {
        var i = e[t] || {};
        return n && (e[t] = i), i
    }
    ...
    function o(e, t, n, i, r) {
        var o = n;
        return e.fire(t + BUI.ucfirst(n) + "Change", {attrName: o, prevVal: i, newVal: r})
    }

    function a(e, t, n, i, r) {
        i = i || {};
        var a, s;
        return s = e.get(t), u.isPlainObject(n) || BUI.isArray(n) || s !== n ? i.silent || !1 !== o(e, "before", t, s, n) ? (a = e._set(t, n, i), a === !1 ? a : (i.silent || (n = e.__attrVals[t], o(e, "after", t, s, n)), e)) : !1 : void 0
    }

    function s(e) {
        if (!e._attrs && e != d) {
            var t = e.superclass.constructor;
            t && !t._attrs && s(t), e._attrs = {}, BUI.mixAttrs(e._attrs, t._attrs), BUI.mixAttrs(e._attrs, e.ATTRS)
        }
    }

    var u = e("jquery"), l = {}, c = e("bui/common/observable"), d = function (e) {
        var t = this, n = t.constructor, i = [];
        for (this.__attrs = {}, this.__attrVals = {}, c.apply(this, arguments); n;) i.push(n), n.extensions && (BUI.mixin(n, n.extensions), delete n.extensions), n = n.superclass ? n.superclass.constructor : null;
        var r = t.constructor;
        s(r), t._initStaticAttrs(r._attrs), t._initAttrs(e)
    };
    d.INVALID = l, BUI.extend(d, c), BUI.augment(d, {
        _initStaticAttrs: function (e) {
            var t, n = this;
            t = n.__attrs = {};
            for (var i in e) if (e.hasOwnProperty(i)) {
                var r = e[i];
                r.shared === !1 || r.valueFn ? (t[i] = {}, BUI.mixAttr(t[i], e[i])) : t[i] = e[i]
            }
        }, addAttr: function (e, t, n) {
            var i = this, r = i.__attrs, o = r[e];
            o || (o = r[e] = {});
            for (var a in t) t.hasOwnProperty(a) && ("value" == a ? BUI.isObject(t[a]) ? (o[a] = o[a] || {}, BUI.mix(o[a], t[a])) : BUI.isArray(t[a]) ? (o[a] = o[a] || [], BUI.mix(o[a], t[a])) : o[a] = t[a] : o[a] = t[a]);
            return i
        }, addAttrs: function (e, t, n) {
            var i = this;
            return e ? ("boolean" == typeof t && (n = t, t = null), BUI.each(e, function (e, t) {
                i.addAttr(t, e, n)
            }), t && i.set(t), i) : i
        }, hasAttr: function (e) {
            ...
            var t, n, o, a = this, s = a.__attrVals;
            ...
            var t, n = this, o = n.__attrs, a = i(o, e), s = a.valueFn;
            return s && (s = r(n, s)) && (t = s.call(n), void 0 !== t && (a.value = t), delete a.valueFn, o[e] = a), a.value
        }, _set: function (e, t, n) {
            var o, a = this, s = i(a.__attrs, e, !0), u = s.setter;
            return u && (u = r(a, u)) && (o = u.call(a, t, e)), o === l ? !1 : (void 0 !== o && (t = o), a.__attrVals[e] = t, a)
        }, _initAttrs: function (e) {
            var t = this;
            if (e) for (var n in e) e.hasOwnProperty(n) && t._set(n, e[n])
        }
    }), n.exports = d
}), define("bui/common/component/component", ["jquery"], function (e, t, n) {
    function i(e, t) {
        var n, i;
        return e && (i = e.xclass) && (t && !e.prefixCls && (e.prefixCls = t.get("prefixCls")), n = r.Manager.getConstructorByXClass(i), n || BUI.error("can not find class by xclass desc : " + i), e = new n(e)), e
    }

    var r = {};
    BUI.mix(r, {
        Manager: e("bui/common/component/manage"),
        UIBase: e("bui/common/component/uibase/uibase"),
        View: e("bui/common/component/view"),
        Controller: e("bui/common/component/controller")
    }), r.create = i, n.exports = r
}), define("bui/common/component/manage", ["jquery"], function (e, t, n) {
    function i(e) {
    ...
    function o(e, t) {
        BUI.isFunction(t) ? u[e] = {constructor: t, priority: 0} : (t.priority = t.priority || 0, u[e] = t)
    }
    ...
    var s = e("jquery"), u = {}, l = {}, c = {
        __instances: l, addComponent: function (e, t) {
            l[e] = t
            ...
            return l[e]
        }, getCssClassWithPrefix: a, getXClassByConstructor: r, getConstructorByXClass: i, setConstructorByXClass: o
    };
    n.exports = c
}), define("bui/common/component/uibase/uibase", ["jquery"], function (e, t, n) {
    var i = e("bui/common/component/uibase/base");
    BUI.mix(i, {
        Align: e("bui/common/component/uibase/align"),
        AutoShow: e("bui/common/component/uibase/autoshow"),
        AutoHide: e("bui/common/component/uibase/autohide"),
        Close: e("bui/common/component/uibase/close"),
        Collapsable: e("bui/common/component/uibase/collapsable"),
        Drag: e("bui/common/component/uibase/drag"),
        KeyNav: e("bui/common/component/uibase/keynav"),
        List: e("bui/common/component/uibase/list"),
        ListItem: e("bui/common/component/uibase/listitem"),
        Mask: e("bui/common/component/uibase/mask"),
        Position: e("bui/common/component/uibase/position"),
        Selection: e("bui/common/component/uibase/selection"),
        StdMod: e("bui/common/component/uibase/stdmod"),
        Decorate: e("bui/common/component/uibase/decorate"),
        Tpl: e("bui/common/component/uibase/tpl"),
        ChildCfg: e("bui/common/component/uibase/childCfg"),
        Bindable: e("bui/common/component/uibase/bindable"),
        Depends: e("bui/common/component/uibase/depends")
    }), BUI.mix(i, {
...
}), define("bui/common/component/uibase/base", ["jquery"], function (e, t, n) {
    function i(e, t) {
    ...
    function r(e, t, n) {
        for (var i, r, o, a, s = e.constructor, u = []; s;) {
            if (a = [], o = s.mixins) for (var l = 0; l < o.length; l++) i = o[l], i && ("constructor" != n && (i = i.prototype.hasOwnProperty(n) ? i.prototype[n] : null), i && a.push(i));
    ...
    function o(e) {
        for (var t, n, i, r = e.constructor; r;) {
            if (r.prototype.hasOwnProperty("destructor") && r.prototype.destructor.apply(e), t = r.mixins) for (i = t.length - 1; i >= 0; i--) n = t[i] && t[i].prototype.__destructor, n && n.apply(e);
            r = r.superclass && r.superclass.constructor
        }
    }

    function a(e) {
        e && BUI.each(e, function (t, n) {
            BUI.isFunction(t) && (e[n] = new t)
        })
    }

    function s(e, t, n) {
        t && BUI.each(t, function (t, i) {
            t[n] && t[n](e)
        })
    }
    ...
    function c(e) {
        ...
        for (var n = t.length - 1; n >= 0; n--) {
            var i = t[n];
            BUI.mix(i.prototype, i.px), BUI.mix(i, i.sx), i.base = null, i.px = null, i.sx = null
        }
    }

    var d = e("jquery"), f = e("bui/common/component/manage"), h = "_uiSet", g = BUI.ucfirst, m = d.noop,
        v = e("bui/common/base"), p = function (e) {
            var t = this;
    ...
    p.ATTRS = {
        ...
        create: function () {
            ...
            return e
        }, createDom: m, renderUI: m, bindUI: m, syncUI: m, destroy: function () {
            var e = this;
        ...
        define: function (e, t, n, i) {
            ...
            return d.isPlainObject(t) && (i = n, n = t, t = []), BUI.extend(r, e), r.base = e, r.px = n, r.sx = i, t.length && (r.extensions = t), r
        }, extend: function y(e, t, n) {
            var i, r = d.makeArray(arguments), o = r[r.length - 1];
            if (r.unshift(this), o.xclass && (r.pop(), r.push(o.xclass)), i = p.define.apply(p, r), o.xclass) {
                var a = o.priority || (this.priority ? this.priority + 1 : 1);
                f.setConstructorByXClass(o.xclass, {
                    constructor: i,
                    priority: a
                }), i.__xclass = o.xclass, i.priority = a, i.toString = function () {
                    return o.xclass
                }
            }
            return i.extend = y, i
...
}), define("bui/common/component/uibase/align", ["jquery"], function (e, t, n) {
    function i(e) {
        var t, n = e.ownerDocument, i = n.body, r = m(e).css("position"), o = "fixed" == r || "absolute" == r;
        if (!o) return "html" == e.nodeName.toLowerCase() ? null : e.parentNode;
        for (t = e.parentNode; t && t != i; t = t.parentNode) if (r = m(t).css("position"), "static" != r) return t;
        return null
    }

    function r(e) {
        var t, n, r, o, a = {left: 0, right: 1 / 0, top: 0, bottom: 1 / 0}, s = e.ownerDocument, u = s.body,
            l = s.documentElement;
        for (t = e; t = i(t);) if ((!v.ie || 0 != t.clientWidth) && t != u && t != l && "visible" != m(t).css("overflow")) {
            var c = m(t).offset();
    ...
    function f(e) {
        ...
        return e.length && !m.isWindow(e[0]) ? (t = e.offset(), n = e.outerWidth(), i = e.outerHeight()) : (t = {
            left: BUI.scrollLeft(),
            top: BUI.scrollTop()
        }, n = BUI.viewportWidth(), i = BUI.viewportHeight()), t.width = n, t.height = i, t
    }

    function h(e, t) {
        var n, i, r = t.charAt(0), o = t.charAt(1), a = e.width, s = e.height;
    ...
    function g(e) {
        var t = e.attr("class"), n = new RegExp("s?" + p + "[a-z]{2}-[a-z]{2}", "ig"), i = n.exec(t);
        i && e.removeClass(i.join(" "))
    }

    var m = e("jquery"), v = e("bui/common/ua"), p = "x-align-", y = window;
    d.__getOffsetParent = i, d.__getVisibleRectForElement = r, d.ATTRS = {
        ...
        _uiSetAlign: function (e, t) {
            var n, i, r = "";
            e && e.points && (this.align(e.node, e.points, e.offset, e.overflow), this.set("cachePosition", null), n = this.get("el"), g(n), i = e.points.join("-"), r = p + i, n.addClass(r))
        }, __bindUI: function () {
            ...
            var d = this, h = d.get("el"), g = 0, v = r(h[0]), p = f(h), b = f(e), I = o(p, b, t, n),
                w = BUI.merge(p, I);
            if (v && (i.adjustX || i.adjustY)) {
                a(I, p, v) && (g = 1, t = l(t, /[lr]/gi, {
                    ...
                    t: "b",
                    b: "t"
                }), n = c(n, 1)), g && (I = o(p, b, t, n), BUI.mix(w, I));
                var C = {};
...
}), define("bui/common/component/uibase/autoshow", ["jquery"], function (e, t, n) {
    function i() {
    }
    ...
    i.ATTRS = {
        ...
        __createDom: function () {
            ...
            function e(e) {
                if (!n.get("disabled")) {
                    var t = n.get("curTrigger"), i = r(l ? e.currentTarget : this), o = n.get("align");
            ...
            var n = this, i = n.get("triggerEvent"), o = n.get("triggerHideEvent"), a = n.get("triggerCallback"),
                s = n.get("triggerActiveCls") || "", u = n.get("trigger"), l = n.get("delegateTrigger"), c = r(u);
            i && (l && BUI.isString(u) ? r(document).delegate(u, i, e) : c.on(i, e)), o && (l && BUI.isString(u) ? r(document).delegate(u, o, t) : c.on(o, t))
        }, __renderUI: function () {
            var e = this, t = e.get("align");
            t && !t.node && (t.node = e.get("render") || e.get("trigger"))
        }
    }, n.exports = i
}), define("bui/common/component/uibase/autohide", ["jquery"], function (e, t, n) {
    function i(e, t) {
    ...
    var o = e("jquery"), a = BUI.wrapBehavior, s = BUI.getWrapBehavior;
    r.ATTRS = {
...
}), define("bui/common/component/uibase/close", ["jquery"], function (e, t, n) {
    function i(e) {
    ...
    var a = e("jquery"), s = BUI.prefix + "ext-";
    r.ATTRS = {
        closeTpl: {value: '<a tabindex="0" href=\'javascript:void("\u5173\u95ed")\' role="button" class="' + s + 'close"><span class="' + s + 'close-x">\u5173\u95ed</span></a>'},
        closeable: {value: !0},
        closeBtn: {}
    }, r.prototype = {
        _uiSetCloseable: function (e) {
            var t = this, n = t.get("closeBtn");
            e ? (n || t.setInternal("closeBtn", n = i(t)), n.appendTo(t.get("el"), void 0)) : n && n.remove()
        }
    };
    var u = "hide";
    o.ATTRS = {closeTpl: {view: !0}, closeable: {view: 1}, closeBtn: {view: 1}, closeAction: {value: u}};
    var l = {hide: u, destroy: "destroy", remove: "remove"};
    o.prototype = {
        _uiSetCloseable: function (e) {
            var t = this;
            ...
            var e = this, t = l[e.get("closeAction") || u];
            e.fire("closing", {action: t}) !== !1 && (e.fire("beforeclosed", {action: t}), "remove" == t ? e[t](!0) : e[t](), e.fire("closed", {action: t}))
        }
    }, o.View = r, n.exports = o
}), define("bui/common/component/uibase/collapsable", [], function (e, t, n) {
    var i = function () {
    };
    i.ATTRS = {collapsed: {}}, i.prototype = {
        _uiSetCollapsed: function (e) {
            var t = this, n = t.getStatusCls("collapsed"), i = t.get("el");
...
}), define("bui/common/component/uibase/drag", ["jquery"], function (e, t, n) {
    function i() {
        var e = r(s).css("opacity", 0).prependTo("body");
        return e
    }

    var r = e("jquery"), o = BUI.guid("drag"), a = function () {
    };
    a.ATTRS = {
        dragNode: {}, draging: {
            setter: function (e) {
    ...
    a.prototype = {
        __bindUI: function () {
            ...
            var o = this, a = o.get("constraint"), s = o.get("dragNode");
            ...
            var o = this, a = o.get("dragBackEl"), n = n || o.get("draging"), s = n.startX - e, u = n.startY - t;
            a.length || (a = i()), a.css({
                cursor: "move",
                display: "block"
            }), o.set("xy", [o._getConstrainX(n.elX - s, r), o._getConstrainY(n.elY - u, r)])
        }, _getConstrainX: function (e, t) {
            var n = this, i = n.get("el").outerWidth(), r = e + i, o = n.get("x");
            if (t) {
                var a = t.offset();
                return a.left >= e ? a.left : a.left + t.width() < r ? a.left + t.width() - i : e
            }
            return BUI.isInHorizontalView(e) && BUI.isInHorizontalView(r) ? e : o
        }, _getConstrainY: function (e, t) {
            var n = this, i = n.get("el").outerHeight(), r = e + i, o = n.get("y");
            if (t) {
                var a = t.offset();
                return a.top > e ? a.top : a.top + t.height() < r ? a.top + t.height() - i : e
            }
            return BUI.isInVerticalView(e) && BUI.isInVerticalView(r) ? e : o
        }
    }, n.exports = a
}), define("bui/common/component/uibase/keynav", ["jquery"], function (e, t, n) {
    var i = e("jquery"), r = e("bui/common/keycode"), o = BUI.wrapBehavior, a = BUI.getWrapBehavior, s = function () {
    };
    s.ATTRS = {
        allowKeyNav: {value: !0},
        ...
        __bindUI: function () {
            ...
            var t = this, n = t.get("navEvent"), i = t.get("el");
            e ? i.on(n, o(t, "_handleKeyDown")) : i.off(n, a(t, "_handleKeyDown"))
        }, _handleKeyDown: function (e) {
            var t = this, n = t.get("ignoreInputFields"), o = e.which;
...
}), define("bui/common/component/uibase/list", ["jquery"], function (e, t, n) {
    function i(e, t) {
        var n = t.isController ? t.getAttrVals() : t, i = e.get("itemTpl"), o = e.get("itemStatusCls"),
    ...
    var o = e("jquery"), a = e("bui/common/component/uibase/selection"), s = function () {
    };
    s.ATTRS = {
    ...
    u.ATTRS = BUI.merge(!0, s.ATTRS, a.ATTRS, {
        items: {sync: !1},
        ...
        __init: function () {
            ...
            e.on(t, function (t) {
                ...
                var n = t.child, i = n.get("selected");
            ...
            var t = this, n = t.get("idField"), i = t.findItemByField(n, e[n]);
            ...
            n = n || this;
            var i = this, r = n.get("children"), a = null;
...
}), define("bui/common/component/uibase/selection", ["jquery"], function (e, t, n) {
    var i = e("jquery"), r = function () {
    };
    r.ATTRS = {
        ...
        clearSelection: function () {
            ...
            var n = this, i = n.findItemByField(e, t);
            n.setSelected(i)
            ...
            var i = this;
            t ? (i.fire("itemselected", {item: e, domTarget: n}), i.fire("selectedchange", {
                item: e,
                domTarget: n,
                selected: t
                ...
                item: e,
                domTarget: n
            }), i.get("multipleSelect") && i.fire("selectedchange", {item: e, domTarget: n, selected: t}))
        }
    }, n.exports = r
}), define("bui/common/component/uibase/listitem", [], function (e, t, n) {
    function i() {
    }
    ...
    i.ATTRS = {selected: {}}, i.prototype = {
        _uiSetSelected: function (e) {
            var t = this, n = t.getStatusCls("selected"), i = t.get("el");
            e ? i.addClass(n) : i.removeClass(n)
        }
    }, r.ATTRS = {
        selectable: {value: !0},
        selected: {view: !0, sync: !1, value: !1}
    }, r.prototype = {}, r.View = i, n.exports = r
}), define("bui/common/component/uibase/mask", ["jquery"], function (e, t, n) {
    function i(e) {
        return e.get("prefixCls") + "ext-mask"
    }

    function r() {
        return f ? BUI.docWidth() + "px" : "100%"
    }

    function o() {
        return f ? BUI.docHeight() + "px" : "100%"
    }
    ...
    var l = e("jquery"), c = e("bui/common/ua"), d = {}, f = 6 == c.ie;
    s.ATTRS = {maskShared: {value: !0}}, s.prototype = {
        _maskExtShow: function () {
            var e, t = this, n = i(t), r = d[n], o = t.get("maskShared"), s = t.get("maskNode");
            ...
            var e = this, t = i(e), n = d[t], r = e.get("maskShared"), o = e.get("maskNode");
    ...
    }, u.ATTRS = {mask: {value: !1}, maskNode: {view: 1}, maskShared: {view: 1}}, u.prototype = {
        __bindUI: function () {
...
}), define("bui/common/component/uibase/position", ["jquery"], function (e, t, n) {
    function i() {
    }
    ...
    i.ATTRS = {
        ...
        __createDom: function () {
            ...
            null != e && this.get("el").offset({left: e})
        }, _uiSetY: function (e) {
            null != e && this.get("el").offset({top: e})
        }, _uiSetLeft: function (e) {
            null != e && this.get("el").css({left: e})
        }, _uiSetTop: function (e) {
            null != e && this.get("el").css({top: e})
        }
    }, r.ATTRS = {
        x: {view: 1}, y: {view: 1}, left: {view: 1}, top: {view: 1}, xy: {
            setter: function (e) {
                var t = this, n = o.makeArray(e);
...
}), define("bui/common/component/uibase/stdmod", ["jquery"], function (e, t, n) {
    function i() {
    }

    function r(e, t) {
        var n = e.get("contentEl"), i = e.get(t);
    ...
    var s = e("jquery"), u = BUI.prefix + "stdmod-";
    i.ATTRS = {
        header: {},
        body: {},
        footer: {},
...
}), define("bui/common/component/uibase/decorate", ["jquery"], function (e, t, n) {
    function i(e, t) {
        if (t[e]) return !0;
        var n = new RegExp("^" + m);
    ...
    function a(e) {
        if (e = f.trim(e), "false" === e.toLowerCase()) e = !1; else if ("true" === e.toLowerCase()) e = !0; else if (I.test(e)) e = h.looseParse(e); else if (/\d/.test(e) && /[^a-z]/i.test(e)) {
            var t = parseFloat(e);
            t + "" === e && (e = t)
        }
        return e
    ...
    function u(e, t) {
        var n, i, r = this, o = r.userConfig || {};
        for (n in t) n in o || (i = t[n], BUI.isFunction(i) ? r.setInternal(n, i.call(r, e)) : "string" == typeof i ? r.setInternal(n, e.find(i)) : BUI.isArray(i) && i[0] && r.setInternal(n, e.find(i[0])))
    }
    ...
    var f = e("jquery"), h = (e("bui/common/array"), e("bui/common/json")), g = BUI.prefix, m = "data-", v = m + "cfg",
        p = "PARSER", y = e("bui/common/component/manage"), b = /-([a-z])/g, I = /^[\{\[]/;
    d.ATTRS = {
        srcNode: {view: !0},
        ...
        getDecorateConfig: function (e) {
            ...
            var t = this, n = e[0], r = n.attributes, s = t.get("decorateCfgFields"), u = {}, l = t._getStautsCfg(e);
            return BUI.each(r, function (e) {
                ...
                try {
                    if (t === v) {
                        ...
                        var r = e.nodeValue;
                        -1 !== t.indexOf(m) && (t = t.replace(m, ""), t = o(t), r = a(r)), u[t] && BUI.isObject(r) ? BUI.mix(u[t], r) : u[t] = r
                    }
                } catch (l) {
            ...
            var t = this, n = {}, i = t.get("statusCls");
            return BUI.each(i, function (t, i) {
                e.hasClass(t) && (n[i] = !0)
            }), n
            ...
            var n = this, i = e.attr("class") || "", r = n.get("defaultChildClass");
            i = i.replace(new RegExp("\\b" + g, "ig"), "");
            var o = y.getConstructorByXClass(i) || y.getConstructorByXClass(r);
            return o || t || (BUI.log(e), BUI.error("can not find ui " + i + " from this markup")), y.getXClassByConstructor(o)
        }, decorateChildrenInternal: function (e, t) {
            var n = this, i = n.get("children");
            i.push({xclass: e, srcNode: t})
        }, decorateChildren: function (e) {
            var t = this, n = t.getDecorateElments();
            BUI.each(n, function (e) {
                var n = t.findXClassByNode(f(e));
                t.decorateChildrenInternal(n, f(e))
            })
        }
    }, n.exports = d
}), define("bui/common/component/uibase/tpl", ["jquery"], function (e, t, n) {
    function i() {
    }
    ...
    e("jquery");
    i.ATTRS = {tpl: {}, tplEl: {}}, i.prototype = {
        __renderUI: function () {
            var e, t = this, n = t.get("childContainer");
            n && (e = t.get("el").find(n), e.length && t.set("contentEl", e))
        }, getTpl: function (e) {
            var t = this, n = t.get("tpl"), i = t.get("tplRender");
            return e = e || t.getAttrVals(), i ? i(e) : n ? BUI.substitute(n, e) : ""
        }, setTplContent: function (e) {
            var t = this, n = t.get("el"), i = t.get("content"), r = (t.get("tplEl"), t.getTpl(e));
...
}), define("bui/common/component/uibase/childCfg", ["jquery"], function (e, t, n) {
    var i = e("jquery"), r = function (e) {
        this._init()
    };
    r.ATTRS = {defaultChildCfg: {}}, r.prototype = {
        _init: function () {
            var e = this, t = e.get("defaultChildCfg");
            t && e.on("beforeAddChild", function (e) {
                var n = e.child;
                i.isPlainObject(n) && BUI.each(t, function (e, t) {
                    null == n[t] && (n[t] = e)
                })
            })
        }
    }, n.exports = r
}), define("bui/common/component/uibase/bindable", [], function (e, t, n) {
    function i() {
    }

    i.ATTRS = {store: {}, loadMask: {value: !1}}, BUI.augment(i, {
        __bindUI: function () {
...
}), define("bui/common/component/uibase/depends", ["jquery"], function (e, t, n) {
    function i(e) {
        var t = l.exec(e), n = t[1], i = t[2], r = a(n);
        return {source: r, eventType: i}
    }

    function r(e, t, n) {
        var r, o = i(t), a = o.source, s = o.eventType;
        return a && n && s && (BUI.isFunction(n) ? r = n : BUI.isArray(n) && (r = function () {
    ...
    function o(e) {
        var t = e.source, n = e.eventType, i = e.callbak;
        t.off(n, i)
    }
    ...
    var u = e("jquery"), l = /^#(.*):(.*)$/, c = e("bui/common/component/manage");
    s.ATTRS = {depends: {}, dependencesMap: {shared: !1, value: {}}}, s.prototype = {
        __syncUI: function () {
            ...
            var n, i = this, o = i.get("dependencesMap");
            i.removeDependence(e), n = r(i, e, t), n && (o[e] = n)
        }, removeDependence: function (e) {
            var t = this, n = t.get("dependencesMap"), i = n[e];
            i && (o(i), delete n[e])
...
}), define("bui/common/component/view", ["jquery"], function (e, t, n) {
    var i = e("jquery"), r = (window, e("bui/common/component/manage")), o = e("bui/common/component/uibase/uibase"),
        a = document, s = o.extend([o.TplView], {
            getComponentCssClassWithState: function (e) {
            ...
            }, getCssClassWithPrefix: r.getCssClassWithPrefix, getKeyEventTarget: function () {
                return this.get("el")
            }, getContentElement: function () {
                return this.get("contentEl") || this.get("el")
            }, getStatusCls: function (e) {
                var t = this, n = t.get("statusCls"), i = n[e];
                return i || (i = t.getComponentCssClassWithState("-" + e)), i
            }, renderUI: function () {
                var e = this;
                if (!e.get("srcNode")) {
                    var t = e.get("render"), n = e.get("el"), i = e.get("elBefore");
                ...
                var t = this, n = t.getStatusCls("hover"), i = t.get("el");
                i[e ? "addClass" : "removeClass"](n)
            }, _uiSetDisabled: function (e) {
                var t = this, n = t.getStatusCls("disabled"), i = t.get("el");
                ...
                var t = this, n = t.get("el"), i = t.getStatusCls("focused");
                ...
                var t = this, n = t.get("el"), i = t.get("visibleMode");
                "visibility" === i ? n.css("visibility", e ? "visible" : "hidden") : n.css("display", e ? "" : "none")
            }, set: function (e, t) {
                var n, r, o, a = this, u = a.__attrs[e];
                if (!u || !a.get("binded")) return s.superclass.set.call(this, e, t), a;
                var l = s.superclass.get.call(this, e);
                return i.isPlainObject(t) || BUI.isArray(t) || l !== t ? (s.superclass.set.call(this, e, t), t = a.__attrVals[e], n = {
                    attrName: e,
                    prevVal: l,
                    newVal: t
                }, r = BUI.ucfirst(e), o = "_uiSet" + r, a[o] && a[o](t, n), a) : a
            }, destructor: function () {
                var e = this.get("el");
                e && e.remove()
            }
...
}), define("bui/common/component/controller", ["jquery"], function (e, t, n) {
    "use strict";

    function i(e, t, n) {
        e.create();
        var i = e.getContentElement(), r = e.get("defaultChildClass");
        return t.xclass || t instanceof g || (t.xtype ? t.xclass = r + "-" + t.xtype : t.xclass = r), t = BUI.Component.create(t, e), t.setInternal("parent", e), t.set("render", i), t.set("elBefore", n), t.create(void 0), t
    }

    function r(e) {
        var t, n, i, r, a = {}, s = e.get("xview");
        t = e.getAttrs();
    ...
    var s = e("jquery"), u = e("bui/common/component/uibase/uibase"), l = e("bui/common/component/manage"),
        c = e("bui/common/component/view"), d = e("bui/common/component/loader"), f = BUI.wrapBehavior,
        h = BUI.getWrapBehavior, g = u.extend([u.Decorate, u.Tpl, u.ChildCfg, u.KeyNav, u.Depends], {
            isController: !0, getCssClassWithPrefix: l.getCssClassWithPrefix, initializer: function () {
                var e = this;
                e.get("id") || e.set("id", e.getNextUniqueId()), l.addComponent(e.get("id"), e);
                var t = r(e);
                e.setInternal("view", t), e.__view = t
            }, getNextUniqueId: function () {
                var e = this, t = l.getXClassByConstructor(e.constructor);
                return BUI.guid(t)
            }, createDom: function () {
                var e = this, t = e.get("view");
                t.create(void 0)
                ...
                var t = this, n = t.get("el"), i = t.get("children"), r = !1;
                return t.get("rendered") ? (s.contains(n[0], e) || n[0] === e ? r = !0 : BUI.each(i, function (t) {
                    return t.containsElement(e) ? (r = !0, !1) : void 0
                }), r) : !1
            }, isChildrenElement: function (e) {
                var t = this, n = t.get("children"), i = !1;
                ...
                var t, n = this, i = n.getKeyEventTarget();
                ...
                var t = this, n = (t.get("el"), t.get("visibleMode"));
                if ("visibility" === n) {
                    if (e) {
                ...
                var n = this, i = n.get("children"), r = BUI.Array.indexOf(e, i);
                if (-1 !== r) return n.fire("beforeRemoveChild", {
                    child: e,
                    destroy: t
                }), -1 !== r && i.splice(r, 1), t && e.destroy && e.destroy(),
                    n.fire("afterRemoveChild", {child: e, destroy: t}), e
            }, removeChildren: function (e) {
                var t, n = this, i = [].concat(n.get("children"));
                ...
                var t, n, i = this, r = (s(e.target), 1 === e.which);
                ...
                return 13 === e.which ? (n || t.fire("click", {
                    domTarget: e.target,
                    domEvent: e
                }), this.performActionInternal(e)) : void(n || t.fire("keydown", {domTarget: e.target, domEvent: e}))
                ...
                var e, t, n = this, i = n.get("children");
                for (e = n.get("id"), t = 0; t < i.length; t++) i[t].destroy && i[t].destroy();
                n.get("view").destroy(), l.removeComponent(e)
            }, set: function (e, t, n) {
                var i, r, o, a = this, u = a.__view, l = a.__attrs[e];
                if (BUI.isObject(e) && (n = t, BUI.each(e, function (e, t) {
                        a.set(t, e, n)
                    })), !u || !l || n && n.silent) return g.superclass.set.call(this, e, t, n), a;
                var c = g.superclass.get.call(this, e);
                return s.isPlainObject(t) || BUI.isArray(t) || c !== t ? (i = BUI.ucfirst(e), o = "_uiSet" + i, a.fire("before" + i + "Change", {
                    attrName: e,
                    prevVal: c,
                    newVal: t
                ...
                var t = this, n = t.__view, i = t.__attrs[e], r = g.superclass.get.call(this, e);
            ...
            ATTRS: {
                ...
                loader: {
                    getter: function (e) {
                        var t, n = this;
                        return e && !e.isLoader && (e.target = n, t = n.get("defaultLoaderCfg"), e = new d(BUI.merge(t, e)), n.setInternal("loader", e)), e
                    }
                },
                ...
                visible: function (e) {
                    var t = this, n = e.css("display"), i = e.css("visibility"), r = t.get("visibleMode");
                    return "none" == n && "display" == r || "hidden" == i && "visibility" == r ? !1 : !0
                }, disabled: function (e) {
                    var t = this, n = t.get("prefixCls") + t.get("xclass") + "-disabled";
                    return e.hasClass(n)
                }
            }
        }, {xclass: "controller", priority: 0});
    n.exports = g
}), define("bui/common/component/loader", ["jquery"], function (e, t, n) {
    "use strict";
    var i = e("jquery"), r = e("bui/common/util"), o = e("bui/common/base"), a = function (e) {
    ...
    a.ATTRS = {
        ...
        isLoader: !0, _init: function () {
            ...
            var t = this, n = t.get("target"), o = t.get("loadMask");
            n && o && e.async("bui/mask", function (e) {
                var a = i.isPlainObject(o) ? o : {};
                o = new e.LoadMask(r.mix({el: n.get("el")}, a)), t.set("loadMask", o)
            })
        }, _initParams: function () {
            var e = this, t = e.get("lastParams"), n = e.get("params");
            r.mix(t, n)
        }, load: function (e) {
            var t = this, n = t.get("url"), o = t.get("ajaxOptions"), a = t.get("lastParams"),
            ...
            e = e || a, e = r.merge(s, e), t.set("lastParams", e), n && (t.onBeforeLoad(), t.set("hasLoad", !0), i.ajax(r.mix({
                ...
                error: function (n, i, r) {
                    t.onException({jqXHR: n, textStatus: i, errorThrown: r}, e)
                }
            }, o)))
            ...
            var n = this, i = n.get("loadMask"), o = n.get("property"), a = n.get("callback"), s = n.get("renderer"),
                u = n.get("target");
            r.isString(e) && u.set(o, ""), u.set(o, s.call(n, e)), i && i.hide && i.hide(), a && a.call(this, e, t)
        }, onException: function (e, t) {
            var n = this, i = n.get("failure");
            i && i.call(this, e, t)
        }
    }), n.exports = a
});