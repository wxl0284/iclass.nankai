...
class Login extends Controller
{
	...
	//登录验证
	public function checkLoginAilab()
	{
	...
	//取消排队
	public function cancelLineUpAilab()
	{
		$rand = trim(input('post.session_id'));
		$where = [
				'session_id' => $rand,
		...
		$del = Db::name('ailab_user')->where($where)->delete();	
		if($del){
